...
Die folgende Aufzählung beschreibt eine Vorlage für das Anforderungsdokument nach Quelle: Sie nutzt die Hilfsmittelsammlung \enquote{Volere}. Diese bietet im Themenbereich \enquote{requirements engineering} kostenpflichtig Dokumentvorlagen an. Die beiden bekanntesten sind die hier gezeigte \enquote{Volere Requirements Specification Template} und das kostenlose \enquote{Volere Atomic Requirement Template}, das umgangssprachlich \enquote{Snow Card} genannt wird. Die \enquote{Snow Card} (\vref{abb:volereSnowCard}) ist eine Karteikarte, die benutzt wird, um eine vollständige Aufnahme aller Informationen einer einzelnen Anforderung zu gewährleisten.\autocite[vgl.][]{VolereSnowCard} 
...
\begin{figure}[H]
	...
	{\footnotesize Quelle: \cite{it_candor_cloud_2019} }
...
\section{Ergänzungen zum Kapitel \ref{kap:container} Container, Containerisierung und Orchestrierung}
...
\begin{table*}[h!]
	...
	\begin{tabular}{@{}llp{9.0cm}@{}}\toprule[1.5pt]
		...
		$A_{4}$ & hoch & Das System muss die Möglichkeit bieten, den Container unabhängig von dem Inhalt dessen zu verteilen.\\
...
Wobei stellen alle Zeichenketten mit dem Muster \enquote{\textit{\$Bezeichner\_}} einen Platzhalter dar. Aus Gründen des Schutzes der Infrastruktur der \ac{SVI}/\ac{SV} ist es nicht gestattet, die wirklichen Endpunkte der Webservices im Klartext abzubilden -- sie unterliegen dem Betriebsgeheimnis.
...
\begin{table*}[h!]
	...
	\begin{tabular}{@{}lp{10cm}l@{}}\toprule[1.5pt]
		...
		skizziert? & $\square$ \\
		9 & Sind zumindest die Top Level Assets und deren Asset und Risk
...
gelten, unterteilen sich in die folgenden Schichten, die wiederum aus weiteren Teilschichten bestehen können.[sic!]
\begin{itemize}
...
\end{itemize}
Neben den Prozess-Bausteinen beinhaltet das IT-Grundschutz-Kompendium auch Sys-tem-Bausteine. Diese werden
...
\begin{itemize}
	...
	Typische Bausteine der Schicht APP sind Allgemeine Groupware, Office-Produkte, Webserver und Relationale [sic!] Datenbanksysteme.
	...
	konkreten Betriebssystemen, Allgemeine [sic!] Smartphones und Tablets sowie Drucker, Kopierer und Multifunktionsgeräte.
	\item Die Schicht IND befasst sich mit Sicherheitsaspekten industrieller IT. In diese Schicht fallen beispielsweise die Bausteine Betriebs- und Steuerungstechnik, Allgemeine [sic!] ICS-Komponente [sic!] und Speicherprogrammierbare [sic!] Steuerung (SPS).
	\item Die Schicht NET betrachtet die Vernetzungsaspekte, die sich nicht primär auf bestimmte IT-Systeme, sondern
	auf die Netzverbindungen und die Kommunikation beziehen. Dazu gehören zum Beispiel die Bausteine NetzManagement [sic!], Firewall und WLAN-Betrieb.
	\item Die Schicht INF befasst sich mit den baulich-technischen Gegebenheiten, hier werden Aspekte der infrastrukturellen Sicherheit zusammengeführt. Dies betrifft unter anderem die Bausteine Allgemeines [sic!] Gebäude und Rechenzentrum."\autocite[][S.\,23-24]{bundesamt_fur_sicherheit_in_der_informationstechnik_bsi_it-grundschutz-kompendium_2020}
\end{itemize}
