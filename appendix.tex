...
% LISTING
\lstinputlisting[language=sh, caption={Funktion zum Test der Verfügbarkeit eines Webseite}, label=lst:testConnection]{resources/listings/testConnection.sh}
...
\chapter{Ergänzungen zum Literaturverzeihnis}
In diesem Kapitel werden die PDF-Dokumente der zitierten Webseiten dargestellt. Dies dient der Nachvollziehbarkeit der Quellen.